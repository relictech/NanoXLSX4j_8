...
public class Packer {
     ...
     * @param contentType URL with information about the content type (MSXML).<br>
     ...
     *                             This information is used in the main content type file
     * @param document             XML document to add
     * @param includeInContentType If true, the content type will be added in the main content type
     *                             file, otherwise not
     * @throws ch.rabanti.nanoxlsx4j.exceptions.IOException Thrown if the document could not be converted to a byte array
     */
