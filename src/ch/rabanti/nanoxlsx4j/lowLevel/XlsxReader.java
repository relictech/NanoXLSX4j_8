...
public class XlsxReader {
     ...
     * @param options Import options to override the automatic approach of the reader.
     ...
     * @throws IOException Throws IOException in case of an error and if throwExceptionIfAbsent is true
     */
