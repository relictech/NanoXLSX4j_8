...
public class WorksheetReader {
    ...
    private String convertToString(Object data) {
        ...
        if (Integer.class.equals(cls)) {
            ...
            TimeComponent t;
            try {
                Method toSecondsMethod = Duration.class.getDeclaredMethod("toSeconds");
                toSecondsMethod.setAccessible(true);
                int seconds = (int) toSecondsMethod.invoke(data);
                t = new TimeComponent(seconds);
            } catch (Exception e) {
                throw new RuntimeException("Patch is not working! - hs");
            }
