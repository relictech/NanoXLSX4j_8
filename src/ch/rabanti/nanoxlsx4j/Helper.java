...
public class Helper {
     ...
     * @throws FormatException Throws a FormatException if the passed date cannot be translated
     ...
     * @throws FormatException thrown if the time could not be parsed or of the pattern was
     *                         invalid
     ...
     * @return Duration object
     * @throws FormatException thrown if the time could not be parsed or of the formatter was
     *                         invalid
     ...
     *
     * @param columnWidth   Target column width (displayed in Excel)
     * @param maxDigitWidth Maximum digit with of the default font (default is 7.0 for
     *                      Calibri, size 11)
     * @param textPadding   Text padding of the default font (default is 5.0 for Calibri, size
     *                      11)
     * @return The internal column width in characters, used in worksheet XML
     * documents
     ...
     *
     * @param internalHeight Internal pane height stored in a worksheet. The minimal value is
     ...
     *
     * @param internalWidth Internal pane width stored in a worksheet. The minimal value is
     ...
     * @return Duration object
     * @throws FormatException thrown if one of the components is invalid (e.g. negative), or if
