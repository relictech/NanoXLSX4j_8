...
public class Workbook {
     ...
     *
     * @param createWorksheet If true, a default worksheet with the name 'Sheet1' will be
     ...
     * saved as stream
     *
     * @param sheetName Name of the first worksheet. The name will be sanitized
     ...
     * @param sanitizeSheetName If true, the name of the worksheet will be sanitized automatically
     ...
     * @param targetWorkbook    Workbook to copy the worksheet into
     * @param sanitizeSheetName If true, the new name will be automatically sanitized if a name
     *                          collision occurs
     * @return Copied worksheet
     * @apiNote The copy is not set as current worksheet. The existing one is kept
     */
     ...
     *
     * @param filename      Filename of the workbook
     * @param importOptions Import options to override the data types of columns or cells.
     ...
     * @throws WorksheetException Throws a WorksheetException if the name of the worksheet is
     *                            unknown or if it is hidden
     * @throws RangeException     Throws a RangeException if the index of the worksheet is out of
     *                            range
     */
     ...
     *
     * @param worksheet Worksheet object (must be in the collection of worksheets)
     * @throws WorksheetException Throws a WorksheetException if the worksheet was not found in the
     ...
     *
     * @param color RGB code in hex format (either 6 characters, e.g. FF00AC or 8
     ...
     * @throws FormatException    Thrown if the worksheet name contains illegal characters or is
     ...
     * @param sanitizeSheetName If true, the name of the worksheet will be sanitized automatically
     *                          according to the specifications of Excel
     * @throws WorksheetException Thrown if the name of the worksheet already exists and
     ...
     *
     * @param worksheet Prepared worksheet object
     * @throws WorksheetException Thrown if the name of the worksheet already exists, when
     *                            sanitation is false
     * @throws FormatException    Thrown if the worksheet name contains illegal characters or is
    ...
    public void removeWorksheet(String name) {
        ...
        if (!worksheetToRemove.isPresent()) {
            throw new WorksheetException("The worksheet with the name '" + name + "' does not exist.");
        }
     ...
     * @throws RangeException Throws a RangeException if the worksheet was not found in the
     ...
     * @param password         Optional password. If null or empty, no password will be set in
     *                         case of protection
     */
     ...
     *
     * @param index                 Index within the worksheets list
     * @param resetCurrentWorksheet If true, the current worksheet will be relocated to the last
