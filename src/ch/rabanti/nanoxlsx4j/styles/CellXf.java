...
public class CellXf extends AbstractStyle {
     ...
     * will be defined
     *
     * @param locked If true, the style is used for locking / protection of cells or
     *               worksheets
     */
     ...
     * will be defined in the XF entry of the style. If true, hidden will be defined
     *
     * @param hidden If true, the style is used for hiding cell values / protection of
     *               cells
     */
     ...
     * defined in the XF entry of the style. If true, applyAlignment will be defined
     *
     * @param forceApplyAlignment If true, the applyAlignment value of the style will be set to true
     *                            (used to merge cells)
     */
