...
public class ImportOptions {
     ...
     *
     * @param enforceDateTimesAsNumbers If true, date or time values (default format number 14 or 21) will
     ...
     *
     * @param enforceEmptyValuesAsString If true, empty cells will be interpreted as type of string with an
     *                                   empty value. If false, the type will be Empty and the value null
     */
