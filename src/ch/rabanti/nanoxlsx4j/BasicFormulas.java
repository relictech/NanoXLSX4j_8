...
public final class BasicFormulas {
     ...
     * Returns a cell with a average formula
     *
     * @param target Target worksheet of the average operation. Can be null if on the
     *               same worksheet
     * @param range  Cell range to apply the average operation to
     * @return Prepared Cell Object, ready to be added to a worksheet
     */
     ...
     * Returns a cell with a ceil formula
     *
     * @param target   Target worksheet of the ceil operation. Can be null if on the same
     *                 worksheet
     * @param address  Address to apply the ceil operation to
     * @param decimals Number of decimals (digits)
     * @return Prepared Cell Object, ready to be added to a worksheet
     ...
     * Returns a cell with a floor formula
     *
     * @param target   Target worksheet of the floor operation. Can be null if on the
     *                 same worksheet
     * @param address  Address to apply the floor operation to
     * @param decimals Number of decimals (digits)
     * @return Prepared Cell Object, ready to be added to a worksheet
     ...
     * Returns a cell with a max formula
     *
     * @param target Target worksheet of the max operation. Can be null if on the same
     *               worksheet
     * @param range  Cell range to apply the max operation to
     * @return Prepared Cell Object, ready to be added to a worksheet
     */
     ...
     * Returns a cell with a median formula
     *
     * @param target Target worksheet of the median operation. Can be null if on the
     *               same worksheet
     * @param range  Cell range to apply the median operation to
     * @return Prepared Cell Object, ready to be added to a worksheet
     */
     ...
     * Returns a cell with a min formula
     *
     * @param target Target worksheet of the min operation. Can be null if on the same
     *               worksheet
     * @param range  Cell range to apply the median operation to
     * @return Prepared Cell Object, ready to be added to a worksheet
     */
     ...
     * Returns a cell with a round formula
     *
     * @param target   Target worksheet of the round operation. Can be null if on the
     *                 same worksheet
     * @param address  Address to apply the round operation to
     * @param decimals Number of decimals (digits)
     * @return Prepared Cell Object, ready to be added to a worksheet
     ...
     * Returns a cell with a sum formula
     *
     * @param target Target worksheet of the sum operation. Can be null if on the same
     *               worksheet
     * @param range  Cell range to get a sum of
     * @return Prepared Cell Object, ready to be added to a worksheet
     */
     ...
     *
     * @param number      Numeric value for the lookup. Valid types are int, long, float and
     *                    double
     ...
     * @param number      Numeric value for the lookup. Valid types are int, long, float and
     *                    double
     * @param rangeTarget Target worksheet of the matrix. Can be null if on the same
     *                    worksheet
     * @param range       Matrix of the lookup
     * @param columnIndex Column index of the target column within the range (1 based)
     * @param exactMatch  If true, an exact match is applied to the lookup
     ...
     * Function to generate a Vlookup as Excel function
     *
     * @param queryTarget Target worksheet of the query argument. Can be null if on the same
     *                    worksheet
     * @param address     Query address of a cell as string as source of the lookup
     * @param rangeTarget Target worksheet of the matrix. Can be null if on the same
     *                    worksheet
     ...
     * @param columnIndex   Column index of the target column within the range (1 based)
     * @param exactMatch    If true, an exact match is applied to the lookup
     * @param numericLookup If true, the lookup is a numeric lookup, otherwise a reference
     *                      lookup
     * @return Prepared Cell Object, ready to be added to a worksheet
     * @throws ch.rabanti.nanoxlsx4j.exceptions.RangeException is thrown if the value or column index is invalid
     ...
     *
     * @param target       Target worksheet of the cell reference. Can be null if on the same
     *                     worksheet
     * @param range        Main argument as cell range. If applied on one cell, the start and
