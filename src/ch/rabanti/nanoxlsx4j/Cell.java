...
public class Cell implements Comparable<Cell> {
     ...
     * @throws FormatException Throws a FormatException if a part of the passed range is
     *                         malformed
     * @throws RangeException  Throws a RangeException if the range is out of range (A-XFD and 1
     *                         to 1048576)
     */
     ...
     * @param startRow    Start roe (zero based)
     * @param endColumn   End column (zero based)
     * @param endRow      End row (zero based)
     * @return List of cell addresses
     * @throws RangeException Throws a RangeException if the value of one passed address parts
     ...
     * @return List of cell addresses
     * @throws FormatException Throws a FormatException if a part of the passed addresses is
     *                         malformed
     * @throws RangeException  Throws a RangeException if the value of one passed address is out
     ...
     * @throws RangeException Throws a RangeException if the start or end address was out of
     *                        range
     */
     ...
     *
     * @param address Address as string in the format A1 - XFD1048576. '$' signs
     ...
     * @throws RangeException  Throws a RangeException if the value of the passed address is out
     *                         of range (A-XFD and 1 to 1048576)
     */
     ...
     *
     * @throws StyleException Thrown if the workbook to remove was not found in the style sheet
     *                        collection
     */
     ...
     * @param isHidden If true, the value of the cell will be invisible if the worksheet
     *                 is protected
     * @throws StyleException Throws an UndefinedStyleException if the style used to lock cells
     ...
     *
     * @param style     style to assign
     * @param unmanaged Internally used: If true, the style repository is not invoked and
